...
import { createDaemonLogger, opaqueIdentity, rootIdentity } from "../dist/daemon/logger.js";
...
test("structured daemon logs omit credentials and full query text", async (t) => {
  ...
  assert.doesNotMatch(text, /secret-token|secret-api-key|sensitive query|private\/repository/);
