...
function searchRoutingRules(exactTool: string, focusedTools: string): string[] {
  return [
    ...
    "Before broad file discovery for a semantic or mixed workspace task, start with a focused zvec_grep_search call. If its results are irrelevant, stop semantic discovery and fall back to focused exact tools.",
