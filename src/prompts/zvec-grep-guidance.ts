export const ZVEC_GREP_WORKSPACE_EVIDENCE_RULES = [
  ...
  "Negative, incidental, or comparative mentions of a workspace do not establish workspace relevance, and an available workspace tool alone is not evidence that the workspace is relevant.",
